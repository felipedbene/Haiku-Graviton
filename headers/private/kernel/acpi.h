...
// SPCR interface types and DBG2 serial port subtypes share one numbering.
enum {
	ACPI_SPCR_INTERFACE_TYPE_16550 = 0,
	ACPI_SPCR_INTERFACE_TYPE_16550_SUBSET = 1,
	ACPI_SPCR_INTERFACE_TYPE_PL011 = 3,
	ACPI_SPCR_INTERFACE_TYPE_SBSA_32BIT = 0x0d,
	ACPI_SPCR_INTERFACE_TYPE_SBSA = 0x0e,
};
...
enum {
	ACPI_DBG2_PORT_SUBTYPE_16550 = ACPI_SPCR_INTERFACE_TYPE_16550,
	ACPI_DBG2_PORT_SUBTYPE_16550_SUBSET = ACPI_SPCR_INTERFACE_TYPE_16550_SUBSET,
	ACPI_DBG2_PORT_SUBTYPE_PL011 = ACPI_SPCR_INTERFACE_TYPE_PL011,
	ACPI_DBG2_PORT_SUBTYPE_SBSA_32BIT = ACPI_SPCR_INTERFACE_TYPE_SBSA_32BIT,
	ACPI_DBG2_PORT_SUBTYPE_SBSA = ACPI_SPCR_INTERFACE_TYPE_SBSA,
};
